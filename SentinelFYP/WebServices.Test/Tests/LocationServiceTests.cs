...
namespace WebServices.Test.Tests
{
    ...
    public class LocationServiceTests
    {
        ...
        public void TestPostGeospatialData()
        {
            ...
            Xunit.Assert.DoesNotThrow(() => client.PostGeospatialData(Location));
        }
        ...
        public void TestPostInvalidGeospatialData()
        {
            ...
            Xunit.Assert.Throws<ProtocolException>(() => client.PostGeospatialData(InvalidLocation));
        }
        ...
        public void TestPostBufferedGeospatialDataSet()
        {
            ...
            Xunit.Assert.DoesNotThrow(() => client.PostBufferedGeospatialDataSet(LocationSet));
        }
        ...
        public void TestPostInvalidBufferedGeospatialDataSet()
        {
            ...
            Xunit.Assert.Throws<ProtocolException>(() => client.PostBufferedGeospatialDataSet(InvalidLocationSet));
        }
